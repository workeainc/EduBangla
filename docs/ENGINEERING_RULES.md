...
Correction UI resolves attendance through the active school and delegates status changes to `CorrectAttendance`; identifiers for session, student, enrollment and academic scope are never mutable.
